...
<%
	...
	String userName = bbsDAO.getUserName(userID);
%>
<meta charset="UTF-8">
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success: function(result){
				if(result == 1){
					...
					autoClosingAlert('#dangersMessage', 2000);
				} else {
	...
	function addChat(chatName, userName, chatContent, chatTime) {
...
<body>
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp" style="font-family: 'Jua', sans-serif;">와이와이</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-nvabar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="index.jsp" style="font-family: 'Jua', sans-serif;">메인</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<a href="#" class="dropdown-toggle"
						...
						aria-expanded="false" style="font-family: 'Jua', sans-serif;">회원관리<span class="caret"></span>
					</a>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="portlet portlet-default">
					...
					<div id="cha" class="panel-collapse collapse in">
